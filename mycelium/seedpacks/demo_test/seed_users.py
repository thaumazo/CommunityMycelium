...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        dummy_users = [
            {
                "username": "fizzgig",
                "email": "fizzgig@example.com",
                "full_name": "Fizzgig Mcluff",
            },
        ]
