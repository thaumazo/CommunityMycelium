...
migrate:
	...
	# edit the migrations files to prevent file changes
	podman exec $(POD_NAME)-web sh -c 'find . -path "*/migrations/*.py" ! -name "__init__.py" -exec sed -i "s/^\(# Generated by Django\).*/\1/" {} +'
